...
printFullName(firstName: "Anunda", lastName: "Sathaworn")
/*:
...
printFullName("Anunda", "Sathaworn")
...
let name = calculateFullName(fullName: "Anunda Sathaworn")
print(name)
...
// TODO: Write solution here
func calculateFullName1(_ fullName: String) -> (name: String, length: Int){
    return (fullName,fullName.count)
}
let ans = calculateFullName1("Anunda Sathaworn")
let (name1, length) = ans
print(length)
